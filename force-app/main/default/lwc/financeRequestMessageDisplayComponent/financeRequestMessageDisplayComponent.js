...
import getMessages from '@salesforce/apex/FinanceRequestChatsController.getMessages';
import { refreshApex } from '@salesforce/apex';

export default class FinanceRequestMessageDisplayComponent extends LightningElement {
    ...
    @wire(getMessages, { financeRequestId: '$recordId' })
