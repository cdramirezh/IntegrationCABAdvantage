        ...
        if (result.data) {
            this.messages = result.data.map((msg, index) => {
                return {
                    ...
                    mgaQuoteName: msg.Related_MGA_Quote__r ? msg.Related_MGA_Quote__r.MGA_Company__r.Name : 'N/A',
                    insuranceCompanyName: msg.Related_Insurance_Co__r ? msg.Related_Insurance_Co__r.Insurance_Company__r.Name : 'N/A'
                };
            });
